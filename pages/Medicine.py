...
# Load other data
sym_des = pd.read_csv("Datasets/Medicine Dataset/symtoms_df.csv")
precautions = pd.read_csv("Datasets/Medicine Dataset/precautions_df.csv")
workout = pd.read_csv("Datasets/Medicine Dataset/workout_df.csv")
description = pd.read_csv("Datasets/Medicine Dataset/description.csv")
medications = pd.read_csv("Datasets/Medicine Dataset/medications.csv")
diets = pd.read_csv("Datasets/Medicine Dataset/diets.csv")
...
def main():
    ...
    if st.button('Predict'):
        if symptoms_input:
            ...
            predicted_disease = diseases_list[svc_model.predict([input_vector])[0]]
...
# Custom function for recommendations
def helper(dis):
